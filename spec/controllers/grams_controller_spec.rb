...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    ...
    it "should redirect_turn 404 message if we cannot find a gram with the id that is specified" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe"grams#edit action" do
    ...
    it "should successfully show the edit form if thr gram is found" do
      gram = FactoryBot.create(:gram)
      sign_in gram.user
  ...
  describe "grams#show action" do
    it "should success show the page if the gram is found" do
      gram = FactoryBot.create(:gram)
